...
public class AppRater {
     ...
     */
    public static void app_launched(Context context, int daysUntilPrompt, int launchesUntilPrompt, int daysForRemind, int launchesForRemind,boolean vesion) {
        setNumDaysForRemindLater(daysForRemind);
        setNumLaunchesForRemindLater(launchesForRemind);
        setVersionCodeCheckEnabled(vesion);
     ...
     */
    @SuppressLint("NewApi")
    private static void showRateAlertDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ApplicationRatingInfo ratingInfo = ApplicationRatingInfo.createApplicationInfo(mContext);
       /* new MaterialDialog.Builder(mContext)
                .title(String.format(mContext.getString(R.string.rate_app_title), ratingInfo.getApplicationName()))
                .content(R.string.rate_app)
                .positiveText("Rate, Thanks")
