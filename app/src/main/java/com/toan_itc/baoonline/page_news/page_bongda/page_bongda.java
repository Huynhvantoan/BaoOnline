package com.toan_itc.baoonline.page_news.page_bongda;
...
public class page_bongda extends Fragment {
    private BaseActivity activity;
    View view;
    int stt;
    public page_bongda(BaseActivity activity, int stt){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            String link = data.getUrlBongda(stt);
            ...
            new ParseNewsTask(activity,link,gridView,Class_khaibao.Bongda).execute();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return view;
