package com.toan_itc.baoonline.page_news.page_dantri;
...
public class page_dantri extends Fragment {
    private BaseActivity activity;
    View view;
    int stt;
    public page_dantri(BaseActivity activity, int stt){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            String link = data.getUrlDantri(stt);
            ...
            new ParseNewsTask(activity,link,gridView,Class_khaibao.Dantri).execute();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return view;
