package com.toan_itc.baoonline.page_news.page_ngoisao;
...
public class page_ngoisao extends Fragment {
    private BaseActivity activity;
    View view;
    int stt;
    public page_ngoisao(BaseActivity activity, int stt){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            String link = data.getUrlNgoiSao(stt);
            ...
            new ParseNewsTask(activity,link,gridView,Class_khaibao.Ngoisao).execute();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return view;
