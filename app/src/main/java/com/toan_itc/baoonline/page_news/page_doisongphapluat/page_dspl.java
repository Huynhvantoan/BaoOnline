package com.toan_itc.baoonline.page_news.page_doisongphapluat;
...
public class page_dspl extends Fragment {
    private BaseActivity activity;
    View view;
    int stt;
    public page_dspl(BaseActivity activity, int stt){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            String link = data.getUrlDoisongphapluat(stt);
            ...
            new ParseNewsTask(activity,link,gridView,Class_khaibao.DSPL).execute();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return view;
