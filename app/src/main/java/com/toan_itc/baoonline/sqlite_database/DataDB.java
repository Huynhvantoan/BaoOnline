...
public class DataDB{
    ...
    public JSONArray exportJson(Context context,String table){
        ...
        try {
            ...
            if (connection.checkDataBase()) {
                        ...
                        if (cursor.getColumnName(i) != null) {
                            try {
                                if (cursor.getString(i) != null) {
                                    Log.wtf("ConvertSQL:"+table+"=", cursor.getString(i));
                                    rowObject.put(cursor.getColumnName(i), cursor.getString(i));
                                } else {
                                    rowObject.put(cursor.getColumnName(i), "");
                                }
                            } catch (Exception e) {
                                Log.d("ConvertSQL", e.getMessage());
                            }
                        }
                    }
                ...
                cursor.close();
                Log.wtf("ConvertSQL:"+table+"=", resultSet.toString());
            }
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    /////
    public ArrayList getTitleTinHot_Tab(Context context) {
        ...
        try {
            ...
            if (connection.checkDataBase()) {
                connection.openDataBase();
                db = connection.getWritableDatabase();
                cursor = db.rawQuery("SELECT title FROM tinhot", null);
