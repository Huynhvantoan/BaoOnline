...
import com.toan_itc.baoonline.progressbar_dialog.Progressbar.view.CustomView;
import com.toan_itc.baoonline.progressbar_dialog.Progressbar.view.Utils;

/**
 * Created by Toan_Kul on 1/12/2015.
 */
public class ProgressBar_custom extends CustomView {

    public ProgressBar_custom(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    }
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        float size = 14;// default ring width
