package com.toan_itc.baoonline.Menucontext;
...
import com.toan_itc.baoonline.Menucontext.interfaces.OnItemClickListener;
import com.toan_itc.baoonline.Menucontext.interfaces.OnItemLongClickListener;
...
public class ContextMenuDialogFragment extends DialogFragment implements OnItemClickListener, OnItemLongClickListener {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            Log.e(TAG, activity.getClass().getSimpleName() +" should implement " + OnMenuItemClickListener.class.getSimpleName());
        }
        try {
            mItemLongClickListener = (OnMenuItemLongClickListener) activity;
        } catch (ClassCastException e) {
            Log.e(TAG, activity.getClass().getSimpleName() +" should implement " + OnMenuItemLongClickListener.class.getSimpleName());
        }
    }
